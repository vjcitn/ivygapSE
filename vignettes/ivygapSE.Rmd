...
```{r loadup, echo=FALSE,message=FALSE}
...
[IvyGAP technical white paper](https://community.brain-map.org/uploads/short-url/jGLtQaClvGNAbZ7EJUoAGTmSTq9.pdf) to
spell out additional background on the data underlying the app and
SummarizedExperiment.

An [API dedicated to IvyGAP](https://community.brain-map.org/t/api-for-ivy-glioblastoma-atlas-project/3041) is available.
...
This vignette was authored in 2018.  The Allen Brain Atlas
resources have matured substantially since then.  This vignette
should be updated for Bioc 3.24.
